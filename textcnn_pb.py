...
class Textcnn_pred(object):
	...
	def text_pre(self,input):
		test_X = create_onehot(one_data=input, vocab_data="./data/vocab.txt", max_length=200)
...
if __name__=="__main__":
	...
	textcnn = Textcnn_pred(pb_path="./checkpoints/textcnn_twoClass.pb")
	pred = textcnn.text_pre(inputs)
	print(pred)